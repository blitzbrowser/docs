...
- Use the [live view](/features/live-view) feature
...
All the details and configurations to deploy the dashboard with BlitzBrowser can be found in the [dashboard configurations](/configurations/dashboard).
