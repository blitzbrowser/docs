...
| `liveView=${boolean}`         | Enable the live view if you want to watch and interact with the browser in real time. You will have the possibility to click, type and scroll directly in the browser.                                                                                                                                                                                                                                                                                                    | Optional |
