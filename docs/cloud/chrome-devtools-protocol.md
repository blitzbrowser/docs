...
|----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|
| `accessKey=${ACCESS_KEY}`        | The access key is required connect to our managed pool of browsers. It's important to keep your access keys private to prevent unauthorized access. You can create your access key from the [access keys dashboard](http://dashboard.blitzbrowser.com/access-keys).                                                                                                                                                                                                              | True     |
